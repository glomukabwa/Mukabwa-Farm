...
<head>
    ...
    <link rel="" href="" type="image/x-ico">
...
<body>
    ...
    <main>
        <!--<section class="intro">
            Don't remove this section. It contains the image that starts the about page
        </section>-->
        <section class="aboutus">
            <div class="content">
                <div class="paragraphs">
                    <div class="first">
                        <h1>About Us</h1>
                        <p>Located in the fertile lands of Kakamega County, our farm was founded by <span style="font-weight: bold;">George Mukabwa</span> and <span style="font-weight: bold;">Mike Mukabwa</span>, two visionaries who shared one powerful mission — to transform their village from dependency to self-sufficiency by producing high-quality farm products that sustain livelihoods and empower the community.</p>
                        <p>For years, the village had been a sleeping giant — blessed with rich soil and favorable weather but untapped potential. While many waited for outside investors, George believed that progress begins with initiative. When he shared his idea with Mike, the vision immediately took root. The co-founder brought innovative strategies and a shared passion for community transformation. Together, they laid the foundation for what would become a thriving agricultural enterprise.</p>
                        <p>Guided by the words “<span style="font-style: italic;">a journey of a thousand miles begins with a single step </span>,”they started small — with just a few local cows. From these humble</p>
                    </div>
                    <div class="second">
                        <p>beginnings, the farm steadily expanded to include chicken, pigs, bulls, maize, and kales, growing into a diverse and sustainable source of income and nourishment for the community.</p>
